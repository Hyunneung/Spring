...
public class Board {
	...
	private int	   BOARD_RE_REF;	// 답변 글 작성 시 참조되는 글 번호
	...
	private MultipartFile uploadfile; // board_write.jsp에서 name 속성 확인 - <input type="file" id="upfile" name="uploadfile">
	private String BOARD_ORIGINAL; // 첨부될 파일의 이름
	private String BOARD_DATE; // 글 등록 날짜
